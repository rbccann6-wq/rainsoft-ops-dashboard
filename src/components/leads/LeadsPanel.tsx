...
import { Target, RefreshCw, Loader2, Phone, MapPin, Store, AlertCircle, CheckCircle2 } from 'lucide-react'
import type { ImeLead, SmartMailBatch } from '@/types'
import { fetchImeLeads, fetchSmartMailBatches } from '@/lib/leadsApi'
      ...
      {!loading && activeTab === 'smartmail' && (
        <div className="space-y-3">
          ...
          <div className="bg-amber-950/30 border border-amber-700/50 rounded-xl p-4 text-sm text-amber-300">
            🔬 OCR extraction coming soon — Google Vision will auto-parse these card scans into structured leads.
          </div>
        </div>
      )}
    </div>
